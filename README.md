This is a nice responsive html5 website for Nipe Sauti Africa built with the latest version of bootstrap framework Sass & Compass (sass files are included).

It is based on Sadaka, a template destined to charity, non-profit organizations websites. This template allows them to present themselves and collect donations for their causes.
